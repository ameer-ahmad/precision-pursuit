  ...
  return (
    <div className="startContainer">
        ...
        <div className="gameOptions">
          <select defaultValue="" onChange={handleSelection} tabIndex="0" id="difficultySelect" name="difficulty-select" className="selectBox">
            <option value="" disabled > -- Select a Difficulty -- </option>
            <option value="easy">Easy</option>
            <option value="medium">Medium</option>
            <option value="hard">Hard</option>
          </select>
          <select defaultValue="" onChange={handleSelection} tabIndex="0" id="speedSelect" name="speed-select" className="selectBox">
            <option value="" disabled > -- Select a Speed -- </option>
            <option value="slow">Slow</option>
            <option value="normal">Normal</option>
            <option value="fast">Fast</option>
          </select>
          <select defaultValue="" onChange={handleSelection} tabIndex="0" id="colourSelect" name="colour-select" className="selectBox">
